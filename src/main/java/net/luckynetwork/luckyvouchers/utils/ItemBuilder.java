package net.luckynetwork.luckyvouchers.utils;
...
public class ItemBuilder {
    ...
    public ItemBuilder flagsList(List<String> list){
    ...
    public ItemBuilder addStringPDC(NamespacedKey namespacedKey, String key){
        this.meta.getPersistentDataContainer().set(namespacedKey, PersistentDataType.STRING, key);
        return this;
    }
